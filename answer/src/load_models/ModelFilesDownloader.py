...
# TODO: move as library or find existing open solution
class ModelFilesDownloader:
    ...
    def load_models(self, cache_dir, tokenizer_url, model_url):
        ...
        model_folder = join_and_create(cache_dir, MODEL_FOLDER)
        model_filename = self.load_file(model_folder, model_url)

        return tokenizer_filename, model_filename
